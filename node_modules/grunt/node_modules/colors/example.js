...
console.log('So '.italic + 'are'.underline + ' style! '.bold + 'inverse'.inverse); // style not widely supported
console.log('Chains are also cool.'.bold.italic.underline.red); // style not widely supported
...
console.log(colors.italic('So ') + colors.underline('are') + colors.bold(' style! ') + colors.inverse('inverse')); // style not widely supported
console.log(colors.bold(colors.italic(colors.underline(colors.red('Chains are also cool.'))))); // style not widely supported
